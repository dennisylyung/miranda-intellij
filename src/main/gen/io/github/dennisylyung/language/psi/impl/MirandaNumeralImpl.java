...
public class MirandaNumeralImpl extends ASTWrapperPsiElement implements MirandaNumeral {

  public MirandaNumeralImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull MirandaVisitor visitor) {
    visitor.visitNumeral(this);
  }
  ...
  @Override
  @Nullable
  public MirandaFloat getFloat() {
    return findChildByClass(MirandaFloat.class);
  }
